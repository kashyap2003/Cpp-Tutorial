...
class Dog: public Animal // : This is the symbol of inheritance after that write mode of inheritance and then write name of class what you have to inherite.
{
public:
    void talk() {cout << "Baoo" << endl;}
};

class Cat: public Animal // : This is the symbol of inheritance after that write mode of inheritance and then write name of class what you have to inherite.
{
public:
    void talk() {cout << "Meow" << endl;}
};

class Dinosaur: public Animal // : This is the symbol of inheritance after that write mode of inheritance and then write name of class what you have to inherite.
{
public:
    void talk() {cout << "Haaooo" << endl;}
};
