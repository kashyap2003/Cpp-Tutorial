...
{
    int x=23, y=15;
    cout << getmax<double, int, double>(20, 30.5) << endl; // We are giving double because there is one double no. in input.
    cout << getmax<double, int, double>(30, 20.5) << endl; // We are giving double because there is one double no. in input.
